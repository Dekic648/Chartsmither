...
const tradeBalance: ChartTemplate = {
  ...
  data: {
    items: [
      { label: 'China', left: 279, right: 0 },
      { label: 'EU', left: 208, right: 0 },
      { label: 'Mexico', left: 152, right: 0 },
      { label: 'Vietnam', left: 104, right: 0 },
      { label: 'Japan', left: 68, right: 0 },
      { label: 'South Korea', left: 44, right: 0 },
      { label: 'Canada', left: 36, right: 0 },
      { label: 'Brazil', left: 0, right: 11 },
      { label: 'Netherlands', left: 0, right: 27 },
      { label: 'Australia', left: 0, right: 18 },
    ],
  },
  options: {
...
const populationDemographics: ChartTemplate = {
  ...
  data: {
    items: [
      { label: '0-9', left: 4.2, right: 4.0 },
      { label: '10-19', left: 4.5, right: 4.3 },
      { label: '20-29', left: 5.1, right: 4.9 },
      { label: '30-39', left: 5.7, right: 5.5 },
      { label: '40-49', left: 7.2, right: 7.0 },
      { label: '50-59', left: 7.8, right: 7.6 },
      { label: '60-69', left: 7.1, right: 7.4 },
      { label: '70-79', left: 6.8, right: 7.5 },
      { label: '80+', left: 3.8, right: 5.5 },
    ],
  },
  options: {
...
const netPromoterScore: ChartTemplate = {
  ...
  data: {
    items: [
      { label: 'Mobile app', left: 12, right: 58 },
      { label: 'Web platform', left: 18, right: 44 },
      { label: 'Customer support', left: 22, right: 51 },
      { label: 'Onboarding', left: 31, right: 38 },
      { label: 'Documentation', left: 25, right: 33 },
      { label: 'Billing', left: 35, right: 28 },
      { label: 'API / integrations', left: 15, right: 61 },
    ],
  },
  options: {
